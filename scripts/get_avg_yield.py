...
if do_get_near_perfect_indices==1:
    np.savetxt(myfolder + '/yield_near_perfect.txt', np.c_[np.arange(data.shape[0]),avgYield,stddevYield], header='No. samples = %d' % nsamples)
else:
