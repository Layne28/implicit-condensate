...
script_name="$HOME/capsid-assembly/llps/droplet/scripts/get_partition_coefficient_hpcc.py"
...
Ebs=(0.000000)
Ecs=(0.000000 1.000000 2.000000 3.000000 4.000000 5.000000 7.000000 8.000000)
#Ebs=(5.0)
#Ecs=(7.0)
    ...
    for L in "${Ls[@]}"; do
        for Vr in "${Vrs[@]}"; do
            for Eb in "${Ebs[@]}"; do
		        ...
		        if [ ! -f $SCRATCH/capsid-assembly/llps/droplet/assembly_trajectories/N=${N}/L=${L}/Vr=${Vr}/E_cond=${Ec}/E_bond=${Eb}/gamma_r=13.333333/seed=${seed}/Kc_traj.txt ]; then
